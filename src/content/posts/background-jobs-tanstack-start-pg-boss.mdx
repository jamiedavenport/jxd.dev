...
TanStack Start is built on [Nitro](https://nitro.build/). Nitro plugins are async functions that run once when the server starts — the right place to initialise pg-boss, declare queues, and register workers.
...
If you're looking for a complete starter kit with pg-boss integrated, register your interest in [Catalyst](https://tally.so/r/EkPZ82) today. 